...
public class UploadTask extends TransferTask {
    ...
    public UploadTask(int taskID, Account account, String repoID, String repoName,
                      ...
                      TransferListener uploadStateListener) {
        super(taskID, account, repoName, repoID, filePath, uploadStateListener);
        this.dir = dir;
    ...
    protected void onProgressUpdate(Long... values) {
        ...
        transferStateListener.onFileUploadProgress(taskID);
    }
    ...
    protected void onPostExecute(File file) {
        ...
        if (transferStateListener != null) {
            if (err == null) {
                transferStateListener.onFileUploaded(taskID);
            }
            else {
                transferStateListener.onFileUploadFailed(taskID);
            }
        }
    }
    ...
    protected void onCancelled() {
        if (transferStateListener != null) {
            transferStateListener.onFileUploadCancelled(taskID);
        }
        transferStateListener.onFileUploadCancelled(taskID);
    }
